        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryName = table.Column<string>(type: "nvarchar(15)", nullable: false, collation: "NOCASE"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyName = table.Column<string>(type: "nvarchar(40)", nullable: false, collation: "NOCASE"),
                    ContactName = table.Column<string>(type: "nvarchar(30)", nullable: true, collation: "NOCASE"),
                    ContactTitle = table.Column<string>(type: "nvarchar(30)", nullable: true, collation: "NOCASE"),
                    Address = table.Column<string>(type: "nvarchar(60)", nullable: true, collation: "NOCASE"),
                    City = table.Column<string>(type: "nvarchar(15)", nullable: true, collation: "NOCASE"),
                    Region = table.Column<string>(type: "nvarchar(15)", nullable: true, collation: "NOCASE"),
                    PostalCode = table.Column<string>(type: "nvarchar(10)", nullable: true, collation: "NOCASE"),
                    Country = table.Column<string>(type: "nvarchar(15)", nullable: true, collation: "NOCASE"),
                    Phone = table.Column<string>(type: "nvarchar(24)", nullable: true, collation: "NOCASE"),
                    Fax = table.Column<string>(type: "nvarchar(24)", nullable: true, collation: "NOCASE")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmployeeID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    LastName = table.Column<string>(type: "nvarchar(20)", nullable: false, collation: "NOCASE"),
                    FirstName = table.Column<string>(type: "nvarchar(10)", nullable: false, collation: "NOCASE"),
                    Title = table.Column<string>(type: "nvarchar(30)", nullable: true, collation: "NOCASE"),
                    TitleOfCourtesy = table.Column<string>(type: "nvarchar(25)", nullable: true, collation: "NOCASE"),
                    ...
                    PostalCode = table.Column<string>(type: "nvarchar(10)", nullable: true, collation: "NOCASE"),
                    Country = table.Column<string>(type: "nvarchar(15)", nullable: true, collation: "NOCASE"),
                    HomePhone = table.Column<string>(type: "nvarchar(24)", nullable: true, collation: "NOCASE"),
                    Extension = table.Column<string>(type: "nvarchar(4)", nullable: true, collation: "NOCASE"),
                    Photo = table.Column<byte[]>(type: "image", nullable: true),
                    Notes = table.Column<string>(type: "ntext", nullable: true),
                    ReportsTo = table.Column<int>(type: "INT", nullable: true),
                    PhotoPath = table.Column<string>(type: "nvarchar(255)", nullable: true, collation: "NOCASE")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegionDescription = table.Column<string>(type: "nchar(50)", nullable: false, collation: "NOCASE")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    CustomerID = table.Column<string>(type: "nchar(5)", nullable: false),
                    CustomerTypeID = table.Column<string>(type: "nchar(10)", nullable: false, collation: "NOCASE")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TerritoryDescription = table.Column<string>(type: "nchar(50)", nullable: false, collation: "NOCASE"),
                    RegionID = table.Column<int>(type: "INT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    CustomerID = table.Column<string>(type: "nchar(5)", nullable: true, collation: "NOCASE"),
                    ...
                    ShipName = table.Column<string>(type: "nvarchar(40)", nullable: true, collation: "NOCASE"),
                    ShipAddress = table.Column<string>(type: "nvarchar(60)", nullable: true, collation: "NOCASE"),
                    ShipCity = table.Column<string>(type: "nvarchar(15)", nullable: true, collation: "NOCASE"),
                    ShipRegion = table.Column<string>(type: "nvarchar(15)", nullable: true, collation: "NOCASE"),
                    ShipPostalCode = table.Column<string>(type: "nvarchar(10)", nullable: true, collation: "NOCASE"),
                    ShipCountry = table.Column<string>(type: "nvarchar(15)", nullable: true, collation: "NOCASE"),
                    ExtraProperties = table.Column<string>(type: "TEXT", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ProductName = table.Column<string>(type: "nvarchar(40)", nullable: false, collation: "NOCASE"),
                    SupplierID = table.Column<int>(type: "INT", nullable: true),
                    CategoryID = table.Column<int>(type: "INT", nullable: true),
                    QuantityPerUnit = table.Column<string>(type: "nvarchar(20)", nullable: true, collation: "NOCASE"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TerritoryID = table.Column<string>(type: "nvarchar(20)", nullable: false, collation: "NOCASE")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "Order Details_OrderID",
                table: "OrderDetails",
                column: "OrderID");

            migrationBuilder.CreateIndex(
                name: "Order Details_OrdersOrder_Details",
                table: "OrderDetails",
                column: "OrderID");

            migrationBuilder.CreateIndex(
                name: "Order Details_ProductID",
                table: "OrderDetails",
                column: "ProductID");

            migrationBuilder.CreateIndex(
                name: "Order Details_ProductsOrder_Details",
                table: "OrderDetails",
                column: "ProductID");
